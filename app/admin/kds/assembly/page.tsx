  ...
  return (
    <div className="flex flex-col flex-1 h-full bg-[#E6E6E6]">
      <div className="p-4 sm:p-8 h-full rounded-tl-3xl shadow-[0_0_15px_rgba(0,0,0,0.05)] flex flex-col bg-white overflow-hidden">
        <Header />
        <Breadcrumbs segments={["Admin", "KDS", "Bowl Assembly"]} />
        <div className="mt-4 flex-1 flex flex-col min-h-0">
          
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 shrink-0">
            <div>
              <h1 className="text-3xl font-black text-neutral-900 tracking-tight">Bowl Assembly</h1>
              <p className="text-neutral-500 font-medium mt-1">Packaging and bowl-specific component checklist</p>
            </div>
          ...
          <div className="flex-1 overflow-y-auto min-h-0 pb-10">
            <BowlAssemblyTab targetDate={targetDate} />
          </div>
        </div>
      </div>
    </div>
